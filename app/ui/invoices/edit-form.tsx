...
import { useFormState } from 'react-dom'; // ADDING useFormState like in create-form.tsx
...
export default function EditInvoiceForm({
  ...
  // const updateInvoiceWithId = updateInvoice.bind(null, invoice.id); // USE useFormState like in create-form.tsx
  const initialState = { message: null, errors: {} };
  const [state, dispatch] = useFormState(updateInvoice, initialState); // USE useFormState
  return (
    // <form action={updateInvoiceWithId}> // USE useFormState
    <form action={dispatch}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div id="invoicesstatus-error" aria-live="polite" aria-atomic="true">
